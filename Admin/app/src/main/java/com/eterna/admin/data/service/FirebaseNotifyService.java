...
//        Intent intent = new Intent(this, HistoryActivity.class); todo create redirection class
...
//        stackBuilder.addNextIntentWithParentStack(intent);
    ...
    private void setupChannels(NotificationManager notificationManager){
        CharSequence adminChannelName = "From Customer";
        String adminChannelDescription = "Vehicle Alert";
